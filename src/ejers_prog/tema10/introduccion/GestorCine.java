...
public class GestorCine {
	...
	public ArrayList<Pelicula> pelisGenero(String genero){
...
private void grabar() {
	...
	public String[] getGeneros() {
		...
		List<Element> peliculas = doc.getRootElement().getChildren("pelicula");
	...
	public static void main(String[] args) {
		GestorCine gc = new GestorCine("files/prueba.xml");
//		System.out.println(gc.peliculaMasLarga().toString());
//		gc.pelisGenero("Drama").forEach(e -> System.out.println(e.toString()));;
//		System.out.println(gc.aniadirPeli(new Pelicula("Harry EL SUCIO", "tragicomedia", 7290), 9));
		gc.crearFicheroConPelisDeUnGenero("Terror", "files/prueba-generos.xml");
